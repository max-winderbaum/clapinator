...
const queryStringEmoji = queryString.parse(window.location.search).emoji;
if (queryStringEmoji) {
  if (queryStringEmoji.match(emojiRegex)) {
    emoji = queryStringEmoji;
  }
  else {
    const searchEmoji = textToEmoji.search(queryStringEmoji)[0];
    if (searchEmoji) {
